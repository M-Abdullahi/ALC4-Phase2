...
public class DealActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.img_deal);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.delete_menu:
                deleteDeal();
                Toast.makeText(this,"The deal was deleted", Toast.LENGTH_LONG).show();
                backToList();
                return true;
            default:
    ...
    private void deleteDeal(){
        ...
        Log.d("Image is being deleted", "image "+deal.getImageName());
        if(deal.getImageName()!=null && !deal.getImageName().isEmpty()){
            ...
            picReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    Log.d("Image Deleted", "onSuccess: Image succesfully deleted");
                }
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(DealActivity.this,
                                "Sorry! Picture couldn't be uploaded", Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
    ...
    public void editImage(View view) {
        ...
        startActivityForResult(Intent.createChooser(intent, "Please Insert Picture"), PICTURE_RESULT);
    }
